...
Two real runs with all artifacts and timings captured verbatim:

- 📊 **[Walkthrough — Powell's FOMC statement](docs/walkthrough-fomc.md)** — a 5:30 Federal Reserve press conference distilled to 5 quantitative highlights. Demonstrates: continuous-narration source, $0 local Whisper, structured macro analysis.
- 🆕 **[Walkthrough — Claude Code release-notes video](docs/walkthrough-claude-code-release.md)** — a 54-second product release video reduced to 5 actionable changes for your workflow. Demonstrates: fast-cut B-roll, 44% dedup reduction, ~30s end-to-end.
